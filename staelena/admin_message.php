                    ...
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                        <form method="POST">
                          ...
                          <br>
                          <input type="text" class="form-control" name="title" placeholder ="MESSAGE TITLE GOES HERE" required>
                          <br>
                          <textarea name="messages" style="width: 100%; height: 100px;" cols="50" placeholder="Message goes here..."></textarea>
                        <br>
                        <div align="right">
