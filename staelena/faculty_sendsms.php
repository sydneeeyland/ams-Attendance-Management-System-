<?php/*
* To run under docker, save to a file named send-sms.php, and then (from the same directory to which you saved the file) run:
*   docker run --rm -v $PWD/send-sms.php:/send-sms.php php:7.3-alpine php send-sms.php
*
...
*/
$username = 'masahiro2020';
$password = 'Sydneydamak029';
/*
...
*/
$url = 'F19AD60BAC9646258F683C7FFB5997E6-02-F/submission/send_sms/2/2.0';
