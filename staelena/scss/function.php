...
//DISPLAY STUDENT DATA ON FACULTY MANAGE MODULE//
   ...
   if(isset($_POST["assignofficer"]))
   {
     ...
     $type = "OFFICER";
     $sql = "UPDATE accounts SET type = '".$type."' WHERE id = '".$studid."'";
     $result = mysqli_query($db, $sql);
...
//SET EVENT FOR FACULTY//
 if(isset($_POST["set_event_time"]))
 {
   ...
   $sql5 = "INSERT INTO fines_time (id, first, first1, second, second1, third, third1, fourth, fourth1)
   VALUES ('$eventid', '$firststart', '$firstend', '$secondstart', '$secondend', '$thirdstart', '$thirdend', '$fourthstart', '$fourthend')";
